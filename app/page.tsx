...
export default function Home() {
    ...
    return (
        <main className="min-h-screen bg-slate-950 text-white">
            <section className="px-5 py-16 sm:px-8 sm:py-20 lg:px-10 lg:py-13">
                    ...
                    {loading ? (
                        ...
                        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
                            ...
                            {users.map((user) => (
                                <article
                                    key={user.id}
                                    className="group flex h-full flex-col overflow-hidden rounded-2xl border border-slate-800 bg-slate-900 p-5 shadow-lg shadow-black/10 transition-all duration-300 hover:-translate-y-1 hover:border-cyan-400/40 hover:shadow-xl hover:shadow-cyan-500/5 sm:p-6"
                                >
